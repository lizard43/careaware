...
if (ToolBar_Supported)
{
	...
	HTMLStr = 
		"<DIV ID='idToolbar'     STYLE='background-color:white;width:100%;overflow:hidden;'>" +
		...
		"<DIV ID='idMSMenuCurve' STYLE='position:absolute;top:0;left:250;height:20;width:18;overflow:hidden;vertical-align:top;'><IMG SRC='curve.gif' BORDER=0></DIV>" +
		...
		"</DIV>" +
		"<DIV ID='idRow2' STYLE='position:relative;left:250;height:40;overflow:hidden;'>" +
...
{	
	//tempGif = "/shared/toolbar/images/" + Gif;
	tempGif = Gif;
